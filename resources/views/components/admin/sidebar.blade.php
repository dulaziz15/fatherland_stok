<aside
    class="sidenav navbar max-height-vh-100 navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            @if (Auth::user()->role == 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('stokOutlet') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Stok Barang Outlet</span>
                    </a>
                </li>
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">User and Account</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ request()->is('reportPenjualan') ? 'active' : '' }}"
                        href="{{ route('penjualanAdmin') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Report Penjualan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  {{ request()->is('logActivity') ? 'active' : '' }}"
                        href="{{ route('logAdmin') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
            ...
            @elseif(Auth::user()->role == 'user')
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Stok Barang</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('action*') ? 'active' : '' }}"
                        href="{{ route('action') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('log*') ? 'active' : '' }}" href="{{ route('log') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
